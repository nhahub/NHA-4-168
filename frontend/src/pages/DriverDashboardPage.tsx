...
export default function DriverDashboardPage() {
  ...
  const statCards = useMemo(() => ([
    { label: 'Total Trips', value: summary?.totalTrips ?? 0, icon: BusFront, iconColor: 'text-emerald-600', iconBg: 'bg-emerald-100' },
    { label: 'Completed Trips', value: summary?.completedTrips ?? 0, icon: CheckCircle2, iconColor: 'text-teal-600', iconBg: 'bg-teal-100' },
    { label: 'Active Trips', value: summary?.activeTrips ?? 0, icon: Route, iconColor: 'text-yellow-600', iconBg: 'bg-yellow-100' },
  ]), [summary]);
